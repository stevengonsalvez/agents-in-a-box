...
**Version:** 1.2 (1.1 amended 2026-09-11 after a distinguished-engineer critique, verdict CAUTION 8/10, 30 amendments folded, see `research/2026-09-11_multi-surface_CRITIQUE-amendments.md`; 1.2 folds spikes 1 and 7)
...
Spikes 1 and 7 done; spikes 4 and 8 can run now. None blocks P0+S.
