...
| C | `2026-09-12-status-t0.md`, then `2026-09-13-963-tui-connection.md`, now #962 | claude-gcp | **merged** #934, #967, #978, #998 (#953, #958, #960, #961, #963 closed); now #962 on `fix/962-fleet-status-panel` | relaunched after the gcp reboot, handle in the orchestrator memory |
...
| I | `2026-09-13-slice1-regressions.md`: #987, #988, #989, #990, one PR each | claude-gcp | worktree `g6-verify`; **merged** #1001 (#988); #997, #999, #1009 reviewed and re-signed, merging on CI; G6 steps 4 and 5 pass on the integrated build | spawned 2026-09-13, handle in the orchestrator memory |
