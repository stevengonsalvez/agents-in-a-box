...
| Phase 2 Versioned sections (wave 3) | 1 | **ready to start** | Phase 3 (met 2026-09-12) | 19 sections, `SectionVersions` | `versioned.rs`, `sections.rs` absent on `v2`; plan `:350` |
...
|---|---|---|---|---|
| A | `2026-09-12-p0-closure.md`: slice-1 gates green (#925), waves 2-4, G6 handed over | claude-hetzner | **merged** #933, #936, #942, #945, #947, #950, #952; Phase 2 (wave 3) in progress | `term_f52c61ee-95c2-4878-beb8-aaf8b8de6abd` |
