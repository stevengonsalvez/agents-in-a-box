...
| C | `2026-09-12-status-t0.md`, then `2026-09-13-963-tui-connection.md`, now #962 | claude-gcp | **merged** #934, #967, #978, #998 (#953, #958, #960, #961, #963 closed); #962 in review as #1014 on `fix/962-fleet-status-panel` (six fixes requested); next goal T0-section per #1015 | relaunched after the gcp reboot, handle in the orchestrator memory |
