...
| F | `2026-09-13-p1-ainb-app.md` then `2026-09-13-p2-p5-effects-and-hosts.md` | claude-hetzner | **merged** #973, #975, #982 (P1), #1000 (P2), #1008 (P3), #1021 (P4); now P5 on `stevengonsalvez/p5-hosts` with #1035 as criteria | `term_fa0949da-d441-4575-b345-a22d9386a74a` |
