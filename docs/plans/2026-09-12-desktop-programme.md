...
| D1 shell, sidecar, terminal tab, sidebar, palette | 3 | goal written: `docs/plans/goals/2026-09-15-d1-desktop-shell.md` (four PRs D1a to D1d, the desktop embeds `ainb-app` as a host, the sidecar is the bundled daemon, no local WS listener, wdio journey with a recorded macOS substitute); preconditions done (#1045, overlay classification, #1077); lane F after #1086 | P2 | wdio sessions journey | base spec D1 |
