...
| P1 `ainb-app` extraction | 2 | **in progress**, staged: P1a service layer **merged** (#973, 84f4c9ef), P1b component pure halves **merged** (#975, e1e817ad), P1c state machine + Chord + Intent in progress (lane F, 2026-09-13) | slice 1 merged (G6 with Stevie) | `cargo test -p ainb-app` runs the moved tests; tripwires green; `renderer_free` guard proves no ratatui or crossterm in the crate | inventory `docs/plans/2026-09-13-p1-extraction-inventory.md`; the spec's 41k LOC and 130-signature figures were wrong, the real move is about 120k LOC |
...
| F | `2026-09-13-p1-ainb-app.md`: P1, the state machine into `ainb-app`, de-crossterm at the host edge | claude-hetzner | worktree `p1-ainb-app`; **merged** #973 (P1a), #975 (P1b); P1c on `stevengonsalvez/p1c-state-machine` | `term_fa0949da-d441-4575-b345-a22d9386a74a` |
