...
| F | `2026-09-13-p1-ainb-app.md` then `2026-09-13-p2-p5-effects-and-hosts.md` | claude-hetzner | **merged** #973, #975, #982 (P1), #1000 (P2), #1008 (P3), #1021 (P4); **merged** #1043 (P5a), #1057 (P5b), #1061 (P5c), #1065 (P5d); #1083 (#1045, plugin input as `Effect::ForwardToPlugin`, runtime handle out of `AppState`; four reviews, seven fixes verified, merge on green), #1084 (#1050, two reviews running) and #1085 (#1051, verified, two lines left) open; follow-ups #1086, #1087 | `term_e68c46ec-80dd-406c-bb9b-0b3cd5659a0a` |
