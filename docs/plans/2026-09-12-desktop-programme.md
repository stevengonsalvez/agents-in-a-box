...
| P1 `ainb-app` extraction | 2 | **in progress** (lane F, 2026-09-13) | slice 1 merged (code complete; G6 human checkpoint with Stevie) | `cargo test -p ainb-app` runs the moved tests; tripwires green; no ratatui or crossterm in the crate | goal `docs/plans/goals/2026-09-13-p1-ainb-app.md` |
...
| F | `2026-09-13-p1-ainb-app.md`: P1, the state machine into `ainb-app`, de-crossterm at the host edge | claude-hetzner | worktree `p1-ainb-app`, branch from `v2` at 09e0cf74 | `term_fa0949da-d441-4575-b345-a22d9386a74a` |
