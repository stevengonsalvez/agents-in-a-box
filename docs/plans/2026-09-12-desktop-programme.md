...
| P6 client reconnect, web onto client, sessions.json to daemon | 2 | **started** 2026-09-16 on lane P (Antigravity on claude-gcp, worktree `p6-client-web`, goal `docs/plans/goals/2026-09-16-p6-client-web.md` on the branch); #1166 (P6a reconnect with 1s/4s/16s backoff and resync on hello, P6b web e2e gated in CI) in review, merge after 13 fixes | P5 | web e2e green; TUI + web + CLI concurrent smoke | base spec |
