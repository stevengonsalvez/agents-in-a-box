...
| C | `2026-09-12-status-t0.md`: #916 pane binding, then T0-daemon, plus the three red daemon tests from #925 | claude-gcp | **merged** #934, #967, #978 (#953, #958, #960, #961 closed); relaunched 2026-09-13 on `2026-09-13-963-tui-connection.md`, branch `fix/963-tui-connection`; #962 waits for lane F P2 | relaunched after the gcp reboot, handle in the orchestrator memory |
...
| I | `2026-09-13-slice1-regressions.md`: #987, #988, #989, #990, one PR each | claude-gcp | worktree `g6-verify`, branches `fix/987-…` to `fix/990-…` from `v2` | spawned 2026-09-13, handle in the orchestrator memory |
| J | `2026-09-14-spikes-5-6-hardware.md`: spikes 5 and 6 on the attached iPhone (iOS 26.4.2) and the Android emulator, from lane G's scratch | m1-mac (Stevie's M1 Pro MacBook, Xcode 26.4.1) | worktree `spikes-5-6-hw`, branch `stevengonsalvez/spikes-5-6-hw` on top of G's branch; owns the closing PR | spawned 2026-09-14, handle in the orchestrator memory |
