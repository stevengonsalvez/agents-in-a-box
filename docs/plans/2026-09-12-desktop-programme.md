...
| K | `2026-09-14-983-redaction-layer.md`: #983 redaction layer, four tests over per-section JSON, locked key-path fixture | claude-gcp | worktree `g6-verify` (reused, warm target), branch `feat/983-redaction-layer` from `v2` | spawned 2026-09-14, handle in the orchestrator memory |
