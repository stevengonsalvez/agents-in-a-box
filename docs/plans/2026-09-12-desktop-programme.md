...
| L | `2026-09-14-proof-harness.md` | claude-gcp | worktree `proof-v2`; branch `feat/proof-harness`; a tmux-driven harness that runs every delivered node against a build of v2 tip and records expected versus observed per node, feeding the status page | spawned 2026-09-14 18:05, handle in the orchestrator memory |
