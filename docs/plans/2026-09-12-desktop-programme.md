...
| F | `2026-09-13-p1-ainb-app.md` then `2026-09-13-p2-p5-effects-and-hosts.md` | claude-hetzner | worktree `p1-ainb-app`; **merged** #973, #975, #982 (P1 complete); **merged** #1000 (P2); now P3 with #1002 as added criteria | `term_fa0949da-d441-4575-b345-a22d9386a74a` |
