...
| D4' updater, release matrix (host switcher moved to R1) | 3 | **started** 2026-09-19 on lane S: goal #1220 (with the repository move planned at the first desktop release) and spec amendment #1231 on v2; D4b release matrix in review as #1230; D4a updater next | D3' | release-branch human-driver run | spec v1.3 amendment 26 |
