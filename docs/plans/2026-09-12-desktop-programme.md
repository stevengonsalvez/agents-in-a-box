...
| T0-section: `agent_status` as section 20 | 4 | **in progress** (lane C, `feat/t0-section`, goal `2026-09-14-t0-section.md`, criteria #1015, 2026-09-14) | P1, T0-daemon (met with follow-ups), #962 | fleet panel renders from the section | spec v1.5; #962 is the prerequisite (panel on `fleet/status`) |
