        ...
        Topic {
            ...
            deps: vec![
                dep("claudecode-statusline", "Claude Code statusline",
                    "5h burn + 7d window + cost in the Claude Code prompt bar", Recommended,
                    Custom("claudecode-statusline"),
                    Manual("wired by `ainb init` (statusline step) or the TUI Budget panel (press W)"),
                    &[], &[]),
                dep("codex-statusline", "Codex statusline",
                    "5h + weekly OAuth quota in the Codex prompt bar", Optional,
